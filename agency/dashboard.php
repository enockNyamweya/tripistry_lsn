...
// Stats
$stmt = $pdo->prepare('SELECT COUNT(*) FROM TRAVEL_PACKAGE WHERE AgencyID = ?');
...
$stmt = $pdo->prepare('SELECT COUNT(*) FROM GROUP_TRIP WHERE AgencyID = ?');
$stmt->execute([$_SESSION['user_id']]);
...
<div class="quick-actions">
    ...
    <a href="group_trips.php" class="btn btn-secondary">Manage Group Trips</a>
</div>
